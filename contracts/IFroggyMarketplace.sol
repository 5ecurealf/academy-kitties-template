...
interface IfroggyMarketPlace {
    ...
    * Requirement: Only the contract owner can call.
    • me: external function 
     */
    function setfroggyContract(address _froggyContractAddress) external;
